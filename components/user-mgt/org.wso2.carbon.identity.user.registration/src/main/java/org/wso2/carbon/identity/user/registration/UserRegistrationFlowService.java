...
public class UserRegistrationFlowService {
    ...
    private static volatile UserRegistrationFlowService instance = new UserRegistrationFlowService();
    ...
    public RegistrationResponse initiateUserRegistration() {

        return new RegistrationResponse();

    }

    public RegistrationResponse processIntermediateUserRegistration() {
