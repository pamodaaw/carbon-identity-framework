...
public class RegistrationRequestManager {
    ...
    private static final Log LOG = LogFactory.getLog(RegistrationRequestManager.class);
    private static volatile RegistrationRequestManager instance;

    public static RegistrationRequestManager getInstance() {

        if (instance == null) {
            synchronized (RegistrationRequestManager.class) {
                if (instance == null) {
                    instance = new RegistrationRequestManager();
                }
            }
        }
        return instance;
    ...
    public void processRegistration(HttpServletRequest request, HttpServletResponse response) {
        ...
        request.setAttribute(SelfRegistrationConstants.REGISTRATION_RESPONSE, registrationResponse);
