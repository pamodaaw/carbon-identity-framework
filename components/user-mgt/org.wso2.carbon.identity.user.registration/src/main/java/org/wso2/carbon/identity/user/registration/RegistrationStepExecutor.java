...
public interface RegistrationStepExecutor {
    ...
    String getName() throws RegistrationFrameworkException;
    ...
    RegistrationResponse execute(RegistrationRequest registrationRequest) throws RegistrationFrameworkException;
