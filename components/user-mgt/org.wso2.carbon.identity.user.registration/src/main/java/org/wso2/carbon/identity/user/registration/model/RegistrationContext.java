...
public class RegistrationContext implements Serializable {
    ...
    private RegistrationFlowConstants.RegistrationFlowStatus flowStatus;
    ...
    public RegistrationFlowConstants.RegistrationFlowStatus getFlowStatus() {

        return flowStatus;
    }

    public void setFlowStatus(RegistrationFlowConstants.RegistrationFlowStatus flowStatus) {
