...
public class AttributeCollectionRegStepExecutor extends RegistrationStepExecutor {

    @Override
    public String getName() throws RegistrationFrameworkException {
    ...
    @Override
    public RegistrationResponse execute(RegistrationRequest registrationRequest) throws RegistrationFrameworkException {
