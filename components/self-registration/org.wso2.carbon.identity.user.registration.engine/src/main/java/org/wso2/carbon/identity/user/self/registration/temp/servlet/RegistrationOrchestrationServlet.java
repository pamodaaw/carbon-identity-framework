...
package org.wso2.carbon.identity.user.self.registration.temp.servlet;
...
public class RegistrationOrchestrationServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException,
        ...
        try {
            ...
            RegistrationDTO registrationDTO = UserRegistrationServiceDataHolder.getRegistrationFlowMgtService()
                    .retrieveRegistrationFlowByTenantId(superTenantDomain);
